...
if method_indx == 1:
    ...
    for ib in range(nbatches):
        if ib == 0:
            ...
            istep, fstep = 2000000, 10000000 + 1
        elif ib == 2:
            istep, fstep = 4000000, 12000000 + 1
        elif ib == 3:
            istep, fstep = 6000000, 14000000 + 1
        elif ib == 4:
            istep, fstep = 8000000, 16000000 + 1
...
if ibatch == 0:
    ...
    dyn_params.update({"icond":2000000})
elif ibatch == 2:
    dyn_params.update({"icond":4000000})
elif ibatch == 3:
    dyn_params.update({"icond":6000000})
elif ibatch == 4:
    dyn_params.update({"icond":8000000})
