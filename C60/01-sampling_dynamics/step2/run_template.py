...
# Lowest and highest orbital, Here HOMO is 120
params['lowest_orbital'] = 120-30
params['highest_orbital'] = 120+14
...
if params['is_periodic']:
    params['A_cell_vector'] = [20.0,0.0,0.0]
    params['B_cell_vector'] = [0.0,20.0,0.0]
    params['C_cell_vector'] = [0.0,0.0,20.0]
...
params['trajectory_xyz_filename'] = path + '/../aligned-C60-pos-1.xyz'
